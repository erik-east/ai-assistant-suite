...
import { useValidateGreetifyData } from "@/services/hooks/use-validate-data";
...
const Home: NextPage = () => {
	...
	const isDataValid = useValidateGreetifyData(recipientName, senderName, relationship, tone, occasion, closeness);
							...
							<div className="mx-auto max-w-3xl text-center">
								...
								<div className="mt-6 flex flex-col items-center justify-center gap-x-6 md:mt-8">
									...
									<div className="container flex items-center justify-center gap-1 xsm:flex-col xsm:p-1 md:flex-row md:gap-16">
										<div className="flex w-full flex-col space-y-2 m-2">
											<DropdownWithLabel
										...
										<div className="flex w-full flex-col space-y-2 mt-2">
											<DropdownWithLabel
												id="tone"
												dropdownClassName="xsm:w-full"
												label="Tone"
									...
									<div className="container flex items-center justify-center gap-1 m-4 xsm:flex-col xsm:p-1 md:flex-row md:gap-16">
										<div className="flex w-full flex-col space-y-2 m-2">
											<DropdownWithLabel
												id="occasion"
												dropdownClassName="xsm:w-full"
								...
								{gptPromptData && (
									<GptResponse
										gptResponse={gptPromptData.response.greeting}
									/>
								)}
