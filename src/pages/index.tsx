								...
								<div className="mt-6 flex flex-col items-center justify-center gap-x-6 md:mt-8">
									...
									<div className="container flex items-center justify-center gap-1 xsm:flex-col xsm:p-1 md:flex-row">
										<div className="flex flex-col w-full space-y-2">
											<Label
												className="md:text-md px-1 capitalize text-left font-bold text-gray-700 xsm:text-sm"
										...
										<div className="flex flex-col w-full py-1 space-y-2">
											<Label
												className="md:text-md px-1 capitalize text-left font-bold text-gray-700 xsm:text-sm"
										...
										<div className="flex flex-col w-full py-1 space-y-2 min-w-[14rem]">
											<Label
												className="md:text-md px-1 capitalize text-left font-bold text-gray-700 xsm:text-sm"
												htmlFor="Interests"
											>
